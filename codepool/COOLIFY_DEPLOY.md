...
3. Set **`LETTA_BASE_URL`**, **`LETTA_API_KEY`** (same as Letta admin password), **`LETTA_MEMFS_LOCAL=1`** (default; **Letta** in root compose uses **Memory Manager** / **`bear-mem-manager`** for git HTTP), optional **`CODEPOOL_INTERNAL_TOKEN`**.
