...
if (!triple) {
    console.warn(
        `bears-acp-adapter: unsupported platform ${key} — skipping binary download.`,
    );
    console.warn(
        "Build from source: cargo build --release --manifest-path tools/bears-acp-adapter/Cargo.toml",
    );
    process.exit(0);
}
