...
| [architecture/adr/](architecture/adr/) | Architecture Decision Records (ADRs) for cross-cutting product/architecture choices: artifacts/Garage, Cabinet ingestion, dynamic skills/subagents, multi-user memory, semantic bear memory, semantic memory schema and work surfaces, reflection, routines. Note: [Bear work surfaces for planning and work activity](architecture/adr/bear-workplaces.md) defines the durable **work surface** model for plans, tasks, artifacts, memory, and work activity. |
