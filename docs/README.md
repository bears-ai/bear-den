...
| [concepts/](concepts/) | Durable cross-functional concepts and vocabulary: [Bears and Den](concepts/BEARS_AND_DEN.md), [Bear roles](concepts/BEAR_ROLES.md), [memory model](concepts/MEMORY_MODEL.md), [tasks and autonomy](concepts/TASKS_AND_AUTONOMY.md), [capabilities and skills](concepts/CAPABILITIES_AND_SKILLS.md), [observations and subscriptions](concepts/OBSERVATIONS_AND_SUBSCRIPTIONS.md), [identity and membership](concepts/IDENTITY_AND_MEMBERSHIP.md) |
