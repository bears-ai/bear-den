...
| [concepts/](concepts/) | Durable cross-functional concepts and vocabulary: [Bears and Den](concepts/BEARS_AND_DEN.md), [Bear agent roles](concepts/BEAR_AGENT_ROLES.md), [Bear Charters and Cabinet Missions](concepts/BEAR_CHARTERS_AND_CABINET_MISSIONS.md), [agent and bear environments](concepts/AGENT_AND_BEAR_ENVIRONMENTS.md), [memory model](concepts/MEMORY_MODEL.md), [tasks and autonomy](concepts/TASKS_AND_AUTONOMY.md), [capabilities and skills](concepts/CAPABILITIES_AND_SKILLS.md), [observations and subscriptions](concepts/OBSERVATIONS_AND_SUBSCRIPTIONS.md), [identity and membership](concepts/IDENTITY_AND_MEMBERSHIP.md) |
...
| [architecture/adr/](architecture/adr/) | Architecture Decision Records (ADRs) for cross-cutting product/architecture choices: artifacts/Garage, Cabinet ingestion, dynamic skills/subagents, multi-user memory, semantic bear memory, routines |
