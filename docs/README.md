...
| [architecture/](architecture/) | Stack notes, Den + multi-user Letta; [Letta vs bear UI coverage](architecture/LETTA_BEAR_UI_EXPOSURE.md); [Den meta tools](architecture/DEN_ARCHITECTURE.md#den-meta-tools-bears-control-plane-tools) (Den-defined control-plane tools and APIs; **LettaBot** brokers execution; not ad hoc scripts in Letta) |
