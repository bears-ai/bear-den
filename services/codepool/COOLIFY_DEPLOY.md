...
**Build locally instead of GHCR:** from the repo root, build the image directly with `docker build -t bear-codepool:local services/codepool`, then set `CODEPOOL_IMAGE=bear-codepool:local` for local compose runs.
