class BearsAcpAdapter < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bears-ai/bear-den/releases/download/bears-acp-adapter%2Fv#{version}/bears-acp-adapter-aarch64-apple-darwin.tar.gz"
      sha256 "" # fill in from `sha256sum` output printed by the release workflow
    end

    on_intel do
      url "https://github.com/bears-ai/bear-den/releases/download/bears-acp-adapter%2Fv#{version}/bears-acp-adapter-x86_64-apple-darwin.tar.gz"
      sha256 "" # fill in from `sha256sum` output printed by the release workflow
    end
  end
