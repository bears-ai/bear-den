...
use crate::{
    ...
    core::{
        ...
        letta::{
            AgentBearPrefill, AgentSummary, LettaAgentDiagnostics, LettaAgentListItem,
            LettaModelOption, LettaToolOption,
        },
    },
    errors::CustomError,
    web::{self, AppState},
...
async fn bear_new_form_context(state: &AppState, form: &NewBearForm) -> minijinja::Value {
